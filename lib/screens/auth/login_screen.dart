...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:  Stack(
        children: [
          Center(child: Image.asset('assets/images/login_background.png',width: 500,height: 1000,scale: 0.2,), widthFactor: 100,heightFactor: 100,),
          Center(
          child: Column(
      ...
      Stack(children: [
        ...
        Positioned(
            ...
            child: ElevatedButton.icon(
                ...
                //google icon
                icon: Image.asset('images/google_logo.png', height: mq.height * .03),
